...
public sealed class ParameterAndRunAtStartupBuilder : OptionChainerBuilder
{
    ...
    /// <returns>Returns the same <see cref="ParameterAndRunAtStartupBuilder"/> that allows further configuration.</returns>
    public ParameterAndRunAtStartupBuilder OnlyIf(Func<bool> predicate)
    {
    ...
    /// <returns>Returns the same <see cref="ParameterAndRunAtStartupBuilder"/> that allows further configuration.</returns>
    public ParameterAndRunAtStartupBuilder OnlyIf(Delegate predicate)
    {
        jobOption.AddCondition(predicate);
    ...
    /// <returns>Returns the same <see cref="ParameterAndRunAtStartupBuilder"/> that allows further configuration.</returns>
    public ParameterAndRunAtStartupBuilder OnlyIf(Func<Task<bool>> predicate)
    {
        jobOption.AddCondition(predicate);
    ...
    public ParameterAndRunAtStartupBuilder WithTimeout(TimeSpan timeout)
    {
    ...
    public ParameterAndRunAtStartupBuilder WithJobRunExpiry(TimeSpan expiry)
    {
