...
///
/// <param name="Name">
/// The optional custom name given to the job. Will be <c>null</c> when no name was specified or when the <see cref="ExecutionProgress"/> instance relates to the start or completion of an orchestration.
/// </param>
///
/// <param name="Type">
/// The type of the job; Will be <c>null</c> if the job is an anonymous function based job or when the <see cref="ExecutionProgress"/> instance relates to the start or completion of an orchestration.
/// </param>
///
